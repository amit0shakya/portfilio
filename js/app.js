...
$(document).ready(function(){
    ...
    $('.workthumb').mouseover(function(){
        var disc = $(this).find('.disc')
        var p=$(this).find('p');
        var span=$(this).find('span');
        
        TweenLite.to(disc,.5,{alpha:.95})
        TweenLite.to([p,span],.5,{y:0})
    })
    
    $('.workthumb').mouseout(function(){
        var disc = $(this).find('.disc')
        var p=$(this).find('p');
        var span=$(this).find('span');
        
        TweenLite.to(disc,.5,{alpha:0});
        TweenLite.to(p,.5,{y:-50});
        TweenLite.to(span,.5,{y:50});
    })
    
    /*
    TweenLite.to('.disc',0,{alpha:0})
    TweenLite.to('.disc p',0,{y:-50})
    TweenLite.to('.disc span',0,{y:50})
    */
    
    
    $(".workthumb").click(function(){
        
        var link = $(this).attr("src");
         window.open(('projects/'+link+'/index.html'), '_blank');
    })
  ...
  //Show Random text animation;
    function screensInit(){   
        ...
        TweenLite.to([".amit"],0,{y:0,x:0,alpha:0})
    ...
    function screen2in(){
       ...
       // TweenLite.to(".workthumb",0,{y:200,alpha:0})
        ...
        TweenLite.to(".workthumb5",1,{y:0,delay:.2,alpha:1})
...
/*        TweenLite.to(".skillsthumb2",1,{delay:.5,alpha:0})
    ...
    function screen4in(){
        TweenLite.to(".amit",1,{x:-100})
        TweenLite.to([".personalinfo",".info2"],0,{y:250})
    ...
    function screen5in(){
        ...
        TweenLite.to(".contact",0,{y:50})
        
       // TweenLite.to(".amit",1,{x:100})
        TweenLite.to(".form",1,{y:0, alpha:1})
        TweenLite.to(".contact",1,{y:0, alpha:1})
    ...
    function screen5out(){
        TweenLite.to(".contact",1,{y:50, alpha:0})
